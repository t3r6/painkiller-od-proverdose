...
function Freezecloud:OnCreateEntity()
    ...
    self.OnDamage = nil
	local smokefx = AddPFX("DevilKosaKula",0.4)
    ENTITY.RegisterChild(self._Entity,smokefx)
end

function Freezecloud:OnUpdate()
...
function Freezecloud:OnRelease()
