function Throwmeat:OnPrecache()
    Cache:PrecacheItem("VampBlood.CItem")    
end

function Throwmeat:OnCreateEntity()
...
function Throwmeat:OnCollision(x,y,z,nx,ny,nz,e,he)
	--[[if e then
