-------------------------------------------------------------------------------
function StoneBullet:OnCreateEntity()
    ENTITY.EnableNetworkSynchronization(self._Entity,true,false,2)
    ENTITY.SetSynchroString(self._Entity,"StoneBullet.CItem")
...
--============================================================================
function StoneBullet:Client_OnCreateEntity(entity)
    local fx = AddPFX("FX_stonebullet",0.5,Vector:New(0,0,0))
    ENTITY.RegisterChild(entity,fx,true)
    PARTICLE.SetParentOffset(fx,0,0,0,nil)
    local t = ENTITY.Create(ETypes.Trail,"trail_kolek","t")
    ENTITY.SetPosition(t,0,0,0)
    ENTITY.AttachTrailToBones(entity,t)
    WORLD.AddEntity(t)
end
--============================================================================
function StoneBullet:OnPrecache()
	Cache:PrecacheParticleFX("FX_stonebullet")
    Cache:PrecacheTrail("trail_spawn")        
end
-------------------------------------------------------------------------------
function StoneBullet:Update()
...
-------------------------------------------------------------------------------
function StoneBullet:Tick(delta)    
...
-------------------------------------------------------------------------------
function StoneBullet:OnCollision(x,y,z,nx,ny,nz,e)
...
-------------------------------------------------------------------------------
function StoneBullet:CL_OnHit(e,x,y,z,mode)
...
Network:RegisterMethod("StoneBullet.CL_OnHit", NCallOn.AllClients, NMode.Reliable, "efffb") 
-------------------------------------------------------------------------------
