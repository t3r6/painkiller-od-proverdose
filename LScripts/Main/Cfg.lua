...
Cfg = 
{
    ...
    BestExplosives = {31,81,},
    BestNonExplosives = {21,71,62,61,51,52,42,32,22,21,12,11,0,},
    BestWeapons1 = {21,0,72,71,62,61,51,52,41,42,31,22,21,12,11,},
    BestWeapons2 = {21,0,72,71,62,61,51,52,41,42,32,31,22,21,11,},
    Bloom = true,
    Brightness = 0.5,
    BrightskinEnemy = "Red",
    BrightskinTeam = "Blue",
...
--ADDED=####################################################################################################
	...
	PROD_CurrentWeapon = false,
	PROD_FragMessage = false,
	PROD_HitSound = false,
...
--ADDED=end##################################################################################################
    ...
    ReverseStereo = false,
    ServerMaps = {},
    ServerMapsFFA = {"DM_Blink","DM_Fortress","DM_Chessboard","DM_Meatless","DM_Powerplant","DM_Ragnarok","DM_riot","DM_Sphere"},
    ServerMapsTDM = {"DM_Meatless","DM_Blink","DM_Sphere","DM_Powerplant"},
    ServerMapsTLB = {"DM_Powerplant","DM_Chessboard","DM_Sphere"},
    ServerMapsPCF = {"DMPCF_Tower","DMPCF_Warehouse"},
    ServerMapsVSH = {"DM_Powerplant","DM_Chessboard","DM_Fortress"},
    ServerMapsCTF = {"CTF_Forbidden","CTF_Chaos","CTF_Trainstation"},
    ServerMapsDUE = {"DM_Fortress","DM_Chessboard","DM_riot"},
    ServerMapsLMS = {"DM_Sphere","DM_Fortress","DM_Meatless","DM_Blink"},
    ServerMapsSRV = {"DM_Blink","DM_Fortress","DM_Chessboard","DM_Meatless","DM_riot","DM_Sphere"},
    ServerName = "PROverdose Server",
    ServerPassword = "",
    ServerPort = 4974,
    SfxVolume = 100,
    Shadows = 0,
...
--============================================================================
function Cfg:Load()
	local gamelang = GetGameLanguage()
	local lang = Cfg.Language
	if gamelang == "FR" then
		lang = "french"
	elseif gamelang == "DE" then
		lang = "german"
	elseif gamelang == "IT" then
		lang = "italian"
	elseif gamelang == "SP" then
		lang = "spanish"
	elseif gamelang == "PL" then
		lang = "polish"
	elseif gamelang == "RU" then
		lang = "russian"
	elseif gamelang == "CZ" then
		lang = "czech"
	elseif gamelang == "EN" then
		lang = "english"
	end
	...
	Cfg.ServerPort = GetDefaultServerPort()
	if IsDemoMulti() or IsDemoPress() then
		Cfg.ServerName = "Overdose MP Demo"
		Cfg.ServerMapsFFA = {"DM_Sphere","DM_Blink"}
		Cfg.ServerMapsTDM = {"DM_Sphere","DM_Blink"}
		Cfg.ServerMapsTLB = {"DM_Sphere"}
		Cfg.ServerMapsPCF = {}
		Cfg.ServerMapsVSH = {}
		Cfg.ServerMapsCTF = {}
		Cfg.ServerMapsDUE = {"DM_Sphere","DM_Blink"}
		Cfg.ServerMapsLMS = {"DM_Sphere","DM_Blink"}
	end
