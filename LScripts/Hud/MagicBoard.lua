...
MagicCards =
{
	timeCards =
	{
		...
		{
			texture = "HUD/Board/Cards/TC_Assault",
			bigImage = "HUD/Board/Cards/Big/TC_Assault",
			name = Languages.Texts[913],
			desc = Languages.Texts[914],
			cost = 500,
			index = 9,
		},

		{
			texture = "HUD/Board/Cards/TC_Steps_of_thunder",
			bigImage = "HUD/Board/Cards/Big/TC_Steps_of_thunder",
			name = Languages.Texts[923],
			desc = Languages.Texts[924],
			cost = 400,
			index = 10,
		},
		...
		{
			texture = "HUD/Board/Cards/TC_Gamble",
			bigImage = "HUD/Board/Cards/Big/TC_Gamble",
			name = Languages.Texts[918],
			desc = Languages.Texts[919],
			cost = 300,
			index = 26,
		},
	...
	permCards =
	{
		...
		{
			texture = "HUD/Board/Cards/PC_Hellish_Armor",
			bigImage = "HUD/Board/Cards/Big/PC_Hellish_Armor",
			name = Languages.Texts[920],
			desc = Languages.Texts[921],
			cost = 1800,
			index = 14,
		},
		...
		{
			texture = "HUD/Board/Cards/PC_Ascendance",
			bigImage = "HUD/Board/Cards/Big/PC_Ascendance",
			name = Languages.Texts[916],
			desc = Languages.Texts[917],
			cost = 1000,
			index = 32,
		},
